...
function executeLogan() {
	var wordArrayLogan = [];
	$.getJSON('https://api.wordnik.com/v4/words.json/randomWords?hasDictionaryDef=true&minCorpusCount=0&minLength=4&maxLength=6&limit=10&api_key=62dcd3414db907722420e014ca302c1c397302ac5e0682878', function (data) {
...
function executeAlex() {
	var wordArrayAlex = [];
	$.getJSON('https://api.wordnik.com/v4/words.json/randomWords?hasDictionaryDef=true&minCorpusCount=0&minLength=4&maxLength=4&limit=10&api_key=62dcd3414db907722420e014ca302c1c397302ac5e0682878', function (data) {
		$.each(data, function (i, item) {
